...
Recently, thanks to x4 Oversampling and /4 Decimation introduction , we have  added 1.25Mhz BW Rec , but it is in the limit of our hardware System limits and it starts to have some M4 sample drops. (It is still experimental). 
